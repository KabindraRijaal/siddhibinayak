...
const PROCESS_STEPS = [
  { num: "01", title: "Consultation & Brief", desc: "We start by deeply understanding your vision, requirements, budget, and timeline through an in-depth consultation session." },
  { num: "02", title: "Design & Planning", desc: "Our architects develop detailed blueprints, 3D renders, and structural plans — refined until they perfectly match your vision." },
  { num: "03", title: "Construction", desc: "Expert crews execute the plan with precision. Regular site updates and quality inspections ensure standards are maintained throughout." },
  { num: "04", title: "Handover & Support", desc: "Final inspection, complete documentation, and a dedicated post-completion support period to ensure your total satisfaction." },
];

export function HomeClient() {
  const cms = useCms();
  const { home, services, projects, testimonials, contact, settings, navigation, about } = cms;
  ...
  return (
    <>
      <Navbar activePage="home" navLinks={navigation} brandName={settings.brandName} />
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center py-20">
            <div>
              ...
              <h1 className="font-head text-[clamp(42px,5vw,64px)] font-extrabold leading-[1.1] tracking-[-0.02em] text-foreground mb-6">
                {home.heroTitle1}<br />
                <span className="text-primary">{home.heroTitle2}</span><br />
                {home.heroTitle3}
              </h1>
              <p className="text-[17px] text-[#4a5568] leading-[1.7] mb-10 max-w-[480px]">{home.heroDesc}</p>
              <div className="flex flex-wrap gap-4">
                <Btn href="/contact">{home.heroPrimaryCta}</Btn>
                <Btn variant="outline" href="/projects">{home.heroSecondaryCta}</Btn>
              </div>
            </div>
            <div className="hidden lg:block relative">
              ...
              <div className="absolute bg-white rounded-2xl px-6 py-5 shadow-[0_8px_40px_rgba(0,0,0,0.12)] flex flex-col gap-1" style={{ bottom: "-20px", left: "-20px" }}>
                <div className="font-head font-extrabold text-[36px] leading-none text-primary">
                  {home.heroBadge.replace(/[^0-9]/g, "")}<span className="text-[#f4b400]">+</span>
                </div>
            ...
            <div>
              ...
              <div className="flex flex-col gap-4">
                {[
                  ...
                  { icon: <svg key="v" width="22" height="22" viewBox="0 0 22 22" fill="none" stroke="#0f2240" strokeWidth="1.8"><circle cx="11" cy="11" r="9"/><path d="M11 6v5l3 3"/></svg>, title: "Our Vision", desc: about.vision },
                  { icon: <svg key="val" width="22" height="22" viewBox="0 0 22 22" fill="none" stroke="#0f2240" strokeWidth="1.8"><path d="M3 19l4-8 4 4 4-6 4 10"/></svg>, title: "Our Values", desc: about.values },
                ].map((p) => (
                  <div key={p.title} className="flex items-start gap-4 p-5 bg-white rounded-xl border border-[#cdd5e3]">
                    <div className="w-10 h-10 rounded-lg bg-[#eff4fa] flex items-center justify-center shrink-0">{p.icon}</div>
                    <div>
              ...
              <div className="mt-8"><Btn href="/about">Learn More About Us →</Btn></div>
            </div>
          </div>
        </Container>
      </section>
        ...
        <Container>
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="flex flex-col gap-5">
              {[
                ...
                <div key={point.title} className="flex items-start gap-4">
                  <div className="w-8 h-8 rounded-full bg-[#f4b400] flex items-center justify-center shrink-0 mt-0.5">
                    <svg viewBox="0 0 16 16" fill="none" stroke="#fff" strokeWidth="2.5" className="w-4 h-4"><path d="M3 8l3.5 3.5L13 4"/></svg>
                  </div>
                  <div>
              ...
              <div className="mt-2"><Btn variant="primary" href="/contact">Start Your Project →</Btn></div>
            </div>
          </div>
        </Container>
      </section>
            ...
            <div>
              ...
              <div className="flex flex-col gap-8">
                {[
                  ...
                  { icon: <svg key="email" width="22" height="22" viewBox="0 0 22 22" fill="none" stroke="#0f2240" strokeWidth="1.8"><path d="M4 4h14a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2z"/><polyline points="2,6 11,13 20,6"/></svg>, label: "Email Us", value: `${contact.email1}\n${contact.email2}` },
                  { icon: <svg key="phone" width="22" height="22" viewBox="0 0 22 22" fill="none" stroke="#0f2240" strokeWidth="1.8"><path d="M15.05 5A5 5 0 0 1 19 8.95M15.05 1A9 9 0 0 1 21 7.95M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 5.5 13a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.41 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg>, label: "Call Us", value: `${contact.phone1}\n${contact.phone2}` },
                  { icon: <svg key="hours" width="22" height="22" viewBox="0 0 22 22" fill="none" stroke="#0f2240" strokeWidth="1.8"><circle cx="11" cy="11" r="9"/><polyline points="11,6 11,11 14,14"/></svg>, label: "Office Hours", value: contact.hours },
                ].map((info) => (
      ...
      <CTABanner title={home.finalCtaTitle} desc={home.finalCtaDesc} ctaLabel={home.finalCtaBtn} ctaHref="/contact" />
