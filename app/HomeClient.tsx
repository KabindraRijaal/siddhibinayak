...
const SERVICE_ICONS = [
  <svg
    ...
    className="w-7 h-7"
  >
    <rect x="3" y="10" width="22" height="16" rx="1.5" />
    <path d="M3 14L14 5l11 9" />
  ...
  <svg
    ...
    className="w-7 h-7"
  >
    <path d="M4 24h20M4 20l8-12 5 7 3-4 4 9" />
  ...
  <svg
    ...
    className="w-7 h-7"
  >
    <path d="M6 22V12M22 22V8M14 22V4M3 22h22" />
    <path d="M10 12h-4v10h4" />
  </svg>,
  <svg
    key="4"
    viewBox="0 0 28 28"
...
export function HomeClient() {
  ...
  const cmsProjects: Project[] = projects.map((p) => ({
    name: p.name,
    category: p.category,
    location: p.location,
    year: p.year,
    area: p.area,
    description: p.desc,
    featured: false, // Equal-width cards on homepage
  ...
  const serviceCards = services.items.map((s, i) => ({
  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(135deg, #fff 0%, #f8f9fa 50%, #fff8e1 100%)",
        }}
      >
        <div
          className="absolute -top-[100px] -right-[200px] w-[700px] h-[700px] rounded-full pointer-events-none"
          style={{
            background:
              "radial-gradient(circle, rgba(15,34,64,0.06) 0%, transparent 70%)",
          }}
        />
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <h1 className="font-head text-[clamp(42px,5vw,64px)] font-extrabold leading-[1.1] tracking-[-0.02em] text-foreground mb-6">
                {home.heroTitle1}
                <br />
                <span className="text-primary">{home.heroTitle2}</span>
                <br />
                {home.heroTitle3}
              </h1>
              ...
              <div className="flex flex-wrap gap-4">
                <Btn href="/contact">{home.heroPrimaryCta}</Btn>
                <Btn variant="outline" href="/projects">
            ...
            <div className="hidden lg:block relative">
              <div
                className="rounded-[20px] overflow-hidden w-full bg-linear-to-br from-[#e7e8e9] to-[#d9dadb] flex flex-col items-center justify-center gap-3 text-[#6b7585] font-mono text-[13px]"
              ...
              <div
                className="absolute bg-white rounded-2xl px-6 py-5 shadow-[0_8px_40px_rgba(0,0,0,0.12)] flex flex-col gap-1"
                style={{ bottom: "-20px", left: "-20px" }}
              >
                <div className="font-head font-extrabold text-[36px] leading-none text-primary">
                  {home.heroBadge.replace(/[^0-9]/g, "")}+
                </div>
                <div className="text-[13px] text-[#3e4a5e] font-medium">
                  Years Experience
                </div>
              </div>
            </div>
        ...
        <Container>
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
            <div>
              ...
              <p className="text-[17px] text-[#4a5568] leading-[1.7] max-w-140">
                {services.pageDesc}
              </p>
            </div>
          </div>
        ...
        <Container>
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div className="relative hidden lg:flex items-center justify-center">
              ...
              <div
                className="absolute overflow-hidden rounded-2xl border-4 border-white shadow-[0_8px_32px_rgba(0,0,0,0.12)]"
                style={{
                  bottom: "-32px",
                  right: "-32px",
                  width: "200px",
              ...
              >
                <div className="w-full h-full bg-linear-to-br from-[#e7e8e9] to-[#d9dadb] flex items-center justify-center text-[#6b7585] font-mono text-[10px]">
                  Baglung hills
                </div>
              </div>
            </div>
            <div>
              ...
              <h2 className="font-head text-[clamp(28px,3.5vw,48px)] font-bold leading-tight tracking-[-0.01em] mb-5">
                {home.aboutTitle}
              </h2>
              ...
              <div className="flex flex-col gap-4">
                {[
                  ...
                  <div
                    key={p.title}
                    className="flex items-start gap-4 p-5 bg-white rounded-xl border border-[#cdd5e3]"
                  >
                    <div className="w-10 h-10 rounded-lg bg-[#eff4fa] flex items-center justify-center shrink-0">
                      {p.icon}
                    </div>
                    <div>
                      <div className="font-head font-bold text-[15px] mb-1">
                        {p.title}
                      </div>
        ...
        <Container>
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
            <div>
              ...
              <h2 className="font-head text-[clamp(28px,3.5vw,48px)] font-bold leading-tight tracking-[-0.01em]">
                Featured Construction Projects
              </h2>
              <p className="text-[17px] text-[#4a5568] mt-3 max-w-xl">
                Explore our portfolio where innovative design and quality
          ...
          <ProjectsGrid projects={cmsProjects} />
        </Container>
      </section>
      ...
      <section className="py-30 bg-[#2e3f5c]">
        <Container>
          ...
          <h2 className="font-head text-[clamp(28px,3.5vw,48px)] font-bold text-white leading-[1.2] tracking-[-0.01em] mb-5">
            Quality That Speaks
            <br />
            For Itself
          </h2>
            ...
            <div className="hidden lg:flex rounded-2xl overflow-hidden aspect-4/3 bg-white/5 items-center justify-center">
              <div className="flex flex-col items-center gap-3 text-white/40 font-mono text-xs">
                ...
                >
                  ...
                  <rect x="16" y="28" width="16" height="14" />
                </svg>
              ...
              {[
                {
                  ...
                  desc: "From foundation to finishing, each element is crafted with meticulous precision. We never cut corners — your structure is built to last generations.",
                },
                {
                  title: "Trusted Expertise, Proven Results",
                  desc: "15+ years building in Baglung's unique terrain. Our engineers understand local soil, seismic requirements, and climate to deliver structures that endure.",
                },
                {
                  title: "Innovative Solutions Tailored for You",
                  desc: "We blend modern construction technology with traditional Nepali design principles to deliver spaces that are uniquely yours.",
                },
                {
                  title: "Your Vision, Our Commitment",
                  desc: "We listen deeply to your needs, maintain transparent communication throughout, and ensure your project is delivered on time and within budget.",
                },
              ].map((point) => (
                <div key={point.title} className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="font-head text-[17px] font-bold text-white mb-1">
                      {point.title}
                    </div>
      ...
      <section className="py-30 bg-background">
        <Container>
          <div className="mb-14">
            ...
            <p className="text-[17px] text-[#4a5568] leading-[1.7] max-w-140">
              A structured, transparent process from initial consultation to
              final handover — ensuring clarity at every step.
            </p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 relative mt-16">
            <div
              ...
              style={{ background: "linear-gradient(90deg, #0f2240, #b08800)" }}
            />
            {PROCESS_STEPS.map((step) => (
              <div key={step.num} className="relative text-center z-10">
                ...
                <h3 className="font-head font-bold text-[16px] mb-2">
                  {step.title}
                </h3>
      ...
      <section className="py-30 bg-white">
        <Container>
          ...
          <h2 className="font-head text-[clamp(28px,3.5vw,48px)] font-bold leading-tight tracking-[-0.01em] mb-4">
            What Our Clients Say
          </h2>
          <p className="text-[17px] text-[#4a5568] leading-[1.7] max-w-140">
            Real stories from real clients across Baglung — the trust they place
            in us drives everything we build.
          </p>
          <div className="mt-16">
        ...
        <Container>
          <div className="grid lg:grid-cols-2 gap-20 mt-16">
            <div>
              ...
              <p className="text-[17px] text-[#4a5568] leading-[1.7] mb-10">
                Ready to build? Fill in the form below and our team will reach
                out within 24 hours to schedule a free consultation.
              </p>
                ...
                {[
                  ...
                  <div key={info.label} className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-[14px] text-[#4a5568] whitespace-pre-line">
                        {info.value}
                      </div>
                    </div>
                  </div>
            ...
            <div>
              <h3 className="font-head text-[22px] font-extrabold mb-6">
                Send Us a Message
              </h3>
              <ContactForm />
            </div>
      ...
      <CTABanner
        ...
        desc={home.finalCtaDesc}
        ctaLabel={home.finalCtaBtn}
        ctaHref="/contact"
      />
