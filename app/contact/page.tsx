...
const CONTACT_INFO = [
  {
    ...
    lines: ["Main Road, Baglung-04", "Baglung District, Gandaki Province", "Nepal 33700"],
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none" stroke="#0f2240" strokeWidth="2">
    ...
    title: "Email Us",
    links: [
      { href: "mailto:info@siddhibinayak.com.np", text: "info@siddhibinayak.com.np" },
      { href: "mailto:design@siddhibinayak.com.np", text: "design@siddhibinayak.com.np" },
    ],
  },
  {
    icon: (
    ...
    title: "Call Us",
    links: [
      { href: "tel:+97768520000", text: "+977 68-520000 (Office)" },
      { href: "tel:+9779800000000", text: "+977 98XXXXXXXX (Mobile)" },
    ],
  },
  {
    icon: (
    ...
    title: "Office Hours",
    lines: ["Sunday – Friday: 9:00 AM – 6:00 PM", "Saturday: 10:00 AM – 2:00 PM"],
  },
];
  ...
  return (
    <>
      ...
      <PageHero
        ...
        desc="Whether you're planning a new home, a commercial project, or a heritage restoration — we'd love to hear about your vision. Reach out and we'll respond within 24 hours."
      />
      ...
      <CTABanner
        ...
        ctaLabel="📞 +977 68-520000"
        ctaHref="tel:+97768520000"
      />
