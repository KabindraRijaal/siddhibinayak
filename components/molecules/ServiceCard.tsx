...
export function ServiceCard({ icon, title, desc, href = "/services" }: ServiceCardProps) {
  return (
    <Link
      href={href}
      className="block px-7 py-8 bg-[#f8f9fa] rounded-2xl border border-transparent hover:bg-primary hover:-translate-y-1.5 hover:shadow-[0_20px_60px_rgba(15,34,64,0.2)] hover:border-primary transition-all duration-300 group cursor-pointer"
    >
      ...
      <p className="text-[14px] text-[#4a5568] leading-[1.7] mb-5 group-hover:text-white transition-colors duration-300">{desc}</p>
